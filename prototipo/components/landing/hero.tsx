      ...
      <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mt-8 text-balance text-4xl font-semibold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
            Revalorizamos el talento de profesionales mayores de 45 anos
          </h1>
          
          <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
            Diagnostico personalizado, formacion en competencias clave y acceso directo a empresas que valoran la experiencia. Una metodologia probada para tu reinsercion laboral.
          </p>
